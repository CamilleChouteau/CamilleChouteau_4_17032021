/*
 ...
 !function(H,bb){"object"==typeof module&&"object"==typeof module.exports?module.exports=H.document?bb(H,!0):function(cb){if(!cb.document)throw Error("jQuery requires a window with a document");return bb(cb)}:bb(H)}("undefined"!=typeof window?window:this,function(H,bb){function cb(a,b,c){var e,f,g=(c=c||O).createElement("script");if(g.text=a,b)for(e in Tc)(f=b[e]||b.getAttribute&&b.getAttribute(e))&&g.setAttribute(e,f);c.head.appendChild(g).parentNode.removeChild(g)}function Qa(a){return null==a?a+
    ...
    m=function(){if(e)return!1;var t=Ya||pc();t=Math.max(0,n.startTime+n.duration-t);for(var v=1-(t/n.duration||0),q=0,z=n.tweens.length;q<z;q++)n.tweens[q].run(v);return h.notifyWith(a,[n,v,t]),1>v&&z?t:(z||h.notifyWith(a,[n,1,0]),h.resolveWith(a,[n]),!1)},n=h.promise({elem:a,props:d.extend({},b),opts:d.extend(!0,{specialEasing:{},easing:d.easing._default},c),originalProperties:b,originalOptions:c,startTime:Ya||pc(),duration:c.duration,tweens:[],createTween:function(t,v){var q=d.Tween(a,n.opts,t,v,n.opts.specialEasing[t]||
    n.opts.easing);return n.tweens.push(q),q},stop:function(t){var v=0,q=t?n.tweens.length:0;if(e)return this;for(e=!0;v<q;v++)n.tweens[v].run(1);return t?(h.notifyWith(a,[n,1,0]),h.resolveWith(a,[n,t])):h.rejectWith(a,[n,t]),this}});c=n.props;!function(t,v){var q,z,A,B,K;for(q in t)if(A=v[z=Aa(q)],B=t[q],Array.isArray(B)&&(A=B[1],B=t[q]=B[0]),q!==z&&(t[z]=B,delete t[q]),(K=d.cssHooks[z])&&"expand"in K)for(q in B=K.expand(B),delete t[z],B)q in t||(t[q]=B[q],v[q]=A);else v[z]=A}(c,n.opts.specialEasing);
    ...
    return g[m]=!0,d.each(a[m]||[],function(t,v){var q=v(b,c,e);return"string"!=typeof q||h||g[q]?h?!(n=q):void 0:(b.dataTypes.unshift(q),f(q),!1)}),n}var g={},h=a===Nb;return f(b.dataTypes[0])||!g["*"]&&f("*")}function Ob(a,b){var c,e,f=d.ajaxSettings.flatOptions||{};for(c in b)void 0!==b[c]&&((f[c]?a:e||(e={}))[c]=b[c]);return e&&d.extend(!0,a,e),a}var Da=[],tc=Object.getPrototypeOf,Ha=Da.slice,hc=Da.flat?function(a){return Da.flat.call(a)}:function(a){return Da.concat.apply([],a)},Pb=Da.push,ob=Da.indexOf,
    nb={},Xb=nb.toString,wb=nb.hasOwnProperty,uc=wb.toString,gd=uc.call(Object),R={},J=function(a){return"function"==typeof a&&"number"!=typeof a.nodeType&&"function"!=typeof a.item},Ra=function(a){return null!=a&&a===a.window},O=H.document,Tc={type:!0,src:!0,nonce:!0,noModule:!0},d=function(a,b){return new d.fn.init(a,b)};d.fn=d.prototype={jquery:"3.6.0",constructor:d,length:0,toArray:function(){return Ha.call(this)},get:function(a){return null==a?Ha.call(this):0>a?this[a+this.length]:this[a]},pushStack:function(a){a=
    d.merge(this.constructor(),a);return a.prevObject=this,a},each:function(a){return d.each(this,a)},map:function(a){return this.pushStack(d.map(this,function(b,c){return a.call(b,c,b)}))},slice:function(){return this.pushStack(Ha.apply(this,arguments))},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},even:function(){return this.pushStack(d.grep(this,function(a,b){return(b+1)%2}))},odd:function(){return this.pushStack(d.grep(this,function(a,b){return b%2}))},eq:function(a){var b=
    ...
    (c=g[b],f=e&&!Array.isArray(c)?[]:e||d.isPlainObject(c)?c:{},e=!1,g[b]=d.extend(n,f,t)):void 0!==t&&(g[b]=t))}return g};d.extend({expando:"jQuery"+("3.6.0"+Math.random()).replace(/\D/g,""),isReady:!0,error:function(a){throw Error(a);},noop:function(){},isPlainObject:function(a){var b,c;return!(!a||"[object Object]"!==Xb.call(a))&&(!(b=tc(a))||"function"==typeof(c=wb.call(b,"constructor")&&b.constructor)&&uc.call(c)===gd)},isEmptyObject:function(a){for(var b in a)return!1;return!0},globalEval:function(a,
    ...
    r.querySelectorAll("[id~="+G+"-]").length||S.push("~=");(u=P.createElement("input")).setAttribute("name","");r.appendChild(u);r.querySelectorAll("[name='']").length||S.push("\\[[\\x20\\t\\r\\n\\f]*name[\\x20\\t\\r\\n\\f]*=[\\x20\\t\\r\\n\\f]*(?:''|\"\")");r.querySelectorAll(":checked").length||S.push(":checked");r.querySelectorAll("a#"+G+"+*").length||S.push(".#.+[+~]");r.querySelectorAll("\\\f");S.push("[\\r\\n\\f]")}),f(function(r){r.innerHTML="<a href='' disabled='disabled'></a><select disabled='disabled'><option/></select>";
    var u=P.createElement("input");u.setAttribute("type","hidden");r.appendChild(u).setAttribute("name","D");r.querySelectorAll("[name=d]").length&&S.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?=");2!==r.querySelectorAll(":enabled").length&&S.push(":enabled",":disabled");X.appendChild(r).disabled=!0;2!==r.querySelectorAll(":disabled").length&&S.push(":enabled",":disabled");r.querySelectorAll("*,:x");S.push(",.*:")})),(D.matchesSelector=gb.test(ya=X.matches||X.webkitMatchesSelector||X.mozMatchesSelector||X.oMatchesSelector||
    X.msMatchesSelector))&&f(function(r){D.disconnectedMatch=ya.call(r,"*");ya.call(r,"[s!='']:x");pa.push("!=",":((?:\\\\[\\da-fA-F]{1,6}[\\x20\\t\\r\\n\\f]?|\\\\[^\\r\\n\\f]|[\\w-]|[^\x00-\\x7f])+)(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|\\[[\\x20\\t\\r\\n\\f]*((?:\\\\[\\da-fA-F]{1,6}[\\x20\\t\\r\\n\\f]?|\\\\[^\\r\\n\\f]|[\\w-]|[^\x00-\\x7f])+)(?:[\\x20\\t\\r\\n\\f]*([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|((?:\\\\[\\da-fA-F]{1,6}[\\x20\\t\\r\\n\\f]?|\\\\[^\\r\\n\\f]|[\\w-]|[^\x00-\\x7f])+))|)[\\x20\\t\\r\\n\\f]*\\])*)|.*)\\)|)")}),
    S=S.length&&new RegExp(S.join("|")),pa=pa.length&&new RegExp(pa.join("|")),l=gb.test(X.compareDocumentPosition),da=l||gb.test(X.contains)?function(r,u){var x=9===r.nodeType?r.documentElement:r,w=u&&u.parentNode;return r===w||!(!w||1!==w.nodeType||!(x.contains?x.contains(w):r.compareDocumentPosition&&16&r.compareDocumentPosition(w)))}:function(r,u){if(u)for(;u=u.parentNode;)if(u===r)return!0;return!1},Rb=l?function(r,u){if(r===u)return xa=!0,0;var x=!r.compareDocumentPosition-!u.compareDocumentPosition;
    ...
    k);return null==r?"!="===l:!l||(r+="","="===l?r===p:"!="===l?r!==p:"^="===l?p&&0===r.indexOf(p):"*="===l?p&&-1<r.indexOf(p):"$="===l?p&&r.slice(-p.length)===p:"~="===l?-1<(" "+r.replace(nd," ")+" ").indexOf(p):"|="===l&&(r===p||r.slice(0,p.length+1)===p+"-"))}},CHILD:function(k,l,p,r,u){var x="nth"!==k.slice(0,3),w="last"!==k.slice(-4),C="of-type"===l;return 1===r&&0===u?function(y){return!!y.parentNode}:function(y,E,L){var aa,Z,I,Q;E=x!==w?"nextSibling":"previousSibling";var T=y.parentNode,wa=C&&
    ...
    p+l:p;++p<l;)k.push(p);return k})}}).pseudos.nth=M.pseudos.eq,{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})M.pseudos[oa]=m(oa);for(oa in{submit:!0,reset:!0})M.pseudos[oa]=n(oa);return z.prototype=M.filters=M.pseudos,M.setFilters=new z,Y=b.tokenize=function(k,l){var p,r,u,x,w,C;if(w=Ma[k+" "])return l?0:w.slice(0);w=k;var y=[];for(C=M.preFilter;w;){for(x in p&&!(r=od.exec(w))||(r&&(w=w.slice(r[0].length)||w),y.push(u=[])),p=!1,(r=vc.exec(w))&&(p=r.shift(),u.push({value:p,type:r[0].replace(zb,
    " ")}),w=w.slice(p.length)),M.filter)!(r=Bb[x].exec(w))||C[x]&&!(r=C[x](r))||(p=r.shift(),u.push({value:p,type:x,matches:r}),w=w.slice(p.length));if(!p)break}return l?w.length:w?b.error(k):Ma(k,y).slice(0)},Za=b.compile=function(k,l){var p,r,u,x,w=[],C=[],y=Ab[k+" "];if(!y){l||(l=Y(k));for(p=l.length;p--;)(y=ha(l[p]))[G]?w.push(y):C.push(y);(y=Ab(k,(r=0<w.length,u=0<C.length,x=function(E,L,aa,Z,I){var Q,T,wa=0,ia="0",fa=E&&[],ba=[],Ac=na,Bc=E||u&&M.find.TAG("*",I),Cc=ea+=null==Ac?1:Math.random()||
    .1,ud=Bc.length;for(I&&(na=L==P||L||I);ia!==ud&&null!=(Q=Bc[ia]);ia++){if(u&&Q){var Sb=0;for(L||Q.ownerDocument==P||(ka(Q),aa=!W);T=C[Sb++];)if(T(Q,L||P,aa)){Z.push(Q);break}I&&(ea=Cc)}r&&((Q=!T&&Q)&&wa--,E&&fa.push(Q))}if(wa+=ia,r&&ia!==wa){for(Sb=0;T=w[Sb++];)T(fa,ba,L,aa);if(E){if(0<wa)for(;ia--;)fa[ia]||ba[ia]||(ba[ia]=ld.call(Z));ba=U(ba)}Ia.apply(Z,ba);I&&!E&&0<ba.length&&1<wa+w.length&&b.uniqueSort(Z)}return I&&(ea=Cc,na=Ac),fa},r?e(x):x))).selector=k}return y},yb=b.select=function(k,l,p,r){var u,
    x,w,C,y,E="function"==typeof k&&k,L=!r&&Y(k=E.selector||k);if(p=p||[],1===L.length){if(2<(x=L[0]=L[0].slice(0)).length&&"ID"===(w=x[0]).type&&9===l.nodeType&&W&&M.relative[x[1].type]){if(!(l=(M.find.ID(w.matches[0].replace(Ea,Fa),l)||[])[0]))return p;E&&(l=l.parentNode);k=k.slice(x.shift().value.length)}for(u=Bb.needsContext.test(k)?0:x.length;u--&&(w=x[u],!M.relative[C=w.type]);)if((y=M.find[C])&&(r=y(w.matches[0].replace(Ea,Fa),Qb.test(x[0].type)&&q(l.parentNode)||l))){if(x.splice(u,1),!(k=r.length&&
    A(x)))return Ia.apply(p,r),p;break}}return(E||Za(k,L))(r,l,!W,p,!l||Qb.test(k)&&q(l.parentNode)||l),p},D.sortStable=G.split("").sort(Rb).join("")===G,D.detectDuplicates=!!xa,ka(),D.sortDetached=f(function(k){return 1&k.compareDocumentPosition(P.createElement("fieldset"))}),f(function(k){return k.innerHTML="<a href='#'></a>","#"===k.firstChild.getAttribute("href")})||g("type|href|height|width",function(k,l,p){if(!p)return k.getAttribute(l,"type"===l.toLowerCase()?1:2)}),D.attributes&&f(function(k){return k.innerHTML=
    ...
    qb),H.addEventListener("load",qb));var Ga=function(a,b,c,e,f,g,h){var m=0,n=a.length,t=null==c;if("object"===Qa(c))for(m in f=!0,c)Ga(a,b,m,c[m],!0,g,h);else if(void 0!==e&&(f=!0,J(e)||(h=!0),t&&(h?(b.call(a,e),b=null):(t=b,b=function(v,q,z){return t.call(d(v),z)})),b))for(;m<n;m++)b(a[m],c,h?e:e.call(a[m],m,b(a[m],c)));return f?a:t?b.call(a):n?b(a[0],c):g},Vc=/^-ms-/,Wc=/-([a-z])/g,hb=function(a){return 1===a.nodeType||9===a.nodeType||!+a.nodeType};db.uid=1;db.prototype={cache:function(a){var b=
    ...
    n,t,v,q,z;var A=F.get(a);if(hb(a))for(c.handler&&(c=(g=c).handler,f=g.selector),f&&d.find.matchesSelector(Pa,f),c.guid||(c.guid=d.guid++),(n=A.events)||(n=A.events=Object.create(null)),(h=A.handle)||(h=A.handle=function(K){return"undefined"!=typeof d&&d.event.triggered!==K.type?d.event.dispatch.apply(a,arguments):void 0}),A=(b=(b||"").match(Ba)||[""]).length;A--;){var B=z=(m=Hc.exec(b[A])||[])[1];m=(m[2]||"").split(".").sort();B&&(v=d.event.special[B]||{},B=(f?v.delegateType:v.bindType)||B,v=d.event.special[B]||
    {},t=d.extend({type:B,origType:z,data:e,handler:c,guid:c.guid,selector:f,needsContext:f&&d.expr.match.needsContext.test(f),namespace:m.join(".")},g),(q=n[B])||((q=n[B]=[]).delegateCount=0,v.setup&&!1!==v.setup.call(a,e,m,h)||a.addEventListener&&a.addEventListener(B,h)),v.add&&(v.add.call(a,t),t.handler.guid||(t.handler.guid=c.guid)),f?q.splice(q.delegateCount++,0,t):q.push(t),d.event.global[B]=!0)}},remove:function(a,b,c,e,f){var g,h,m,n,t,v,q,z,A=F.hasData(a)&&F.get(a);if(A&&(n=A.events)){for(t=
    (b=(b||"").match(Ba)||[""]).length;t--;)if(v=z=(m=Hc.exec(b[t])||[])[1],q=(m[2]||"").split(".").sort(),v){var B=d.event.special[v]||{};var K=n[v=(e?B.delegateType:B.bindType)||v]||[];m=m[2]&&new RegExp("(^|\\.)"+q.join("\\.(?:.*\\.|)")+"(\\.|$)");for(h=g=K.length;g--;){var U=K[g];!f&&z!==U.origType||c&&c.guid!==U.guid||m&&!m.test(U.namespace)||e&&e!==U.selector&&("**"!==e||!U.selector)||(K.splice(g,1),U.selector&&K.delegateCount--,B.remove&&B.remove.call(a,U))}h&&!K.length&&(B.teardown&&!1!==B.teardown.call(a,
    q,A.handle)||d.removeEvent(a,v,A.handle),delete n[v])}else for(v in n)d.event.remove(a,v+b[t],c,e,!0);d.isEmptyObject(n)&&F.remove(a,"handle events")}},dispatch:function(a){var b,c,e,f,g=Array(arguments.length),h=d.event.fix(a);var m=(F.get(this,"events")||Object.create(null))[h.type]||[];var n=d.event.special[h.type]||{};g[0]=h;for(b=1;b<arguments.length;b++)g[b]=arguments[b];if(h.delegateTarget=this,!n.preDispatch||!1!==n.preDispatch.call(this,h)){var t=d.event.handlers.call(this,h,m);for(b=0;(e=
    t[b++])&&!h.isPropagationStopped();)for(h.currentTarget=e.elem,m=0;(f=e.handlers[m++])&&!h.isImmediatePropagationStopped();)h.rnamespace&&!1!==f.namespace&&!h.rnamespace.test(f.namespace)||(h.handleObj=f,h.data=f.data,void 0!==(c=((d.event.special[f.origType]||{}).handle||f.handler).apply(e.elem,g))&&!1===(h.result=c)&&(h.preventDefault(),h.stopPropagation()));return n.postDispatch&&n.postDispatch.call(this,h),h.result}},handlers:function(a,b){var c,e,f,g=[],h=b.delegateCount,m=a.target;if(h&&m.nodeType&&
    !("click"===a.type&&1<=a.button))for(;m!==this;m=m.parentNode||this)if(1===m.nodeType&&("click"!==a.type||!0!==m.disabled)){var n=[];var t={};for(c=0;c<h;c++)void 0===t[f=(e=b[c]).selector+" "]&&(t[f]=e.needsContext?-1<d(f,this).index(m):d.find(f,this,null,[m]).length),t[f]&&n.push(e);n.length&&g.push({elem:m,handlers:n})}return m=this,h<b.length&&g.push({elem:m,handlers:b.slice(h)}),g},addProp:function(a,b){Object.defineProperty(d.Event.prototype,a,{enumerable:!0,configurable:!0,get:J(b)?function(){if(this.originalEvent)return b(this.originalEvent)}:
    ...
    b&&"function"!=typeof b||(c=b,b=void 0),!1===c&&(c=Wa),this.each(function(){d.event.remove(this,a,c,b)})}});var Bd=/<script|<style|<link/i,cd=/checked\s*(?:[^=]|=\s*.checked.)/i,dd=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;d.extend({htmlPrefilter:function(a){return a},clone:function(a,b,c){var e,f,g,h=a.cloneNode(!0),m=Ua(a);if(!(R.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||d.isXMLDoc(a))){var n=ma(h);var t=0;for(e=(f=ma(a)).length;t<e;t++){var v=f[t];var q=n[t];void 0;"input"===(g=q.nodeName.toLowerCase())&&
    ib.test(v.type)?q.checked=v.checked:"input"!==g&&"textarea"!==g||(q.defaultValue=v.defaultValue)}}if(b)if(c)for(f=f||ma(a),n=n||ma(h),t=0,e=f.length;t<e;t++)gc(f[t],n[t]);else gc(a,h);return 0<(n=ma(h,"script")).length&&Fb(n,!m&&ma(a,"script")),h},cleanData:function(a){for(var b,c,e,f=d.event.special,g=0;void 0!==(c=a[g]);g++)if(hb(c)){if(b=c[F.expando]){if(b.events)for(e in b.events)f[e]?d.event.remove(c,e):d.removeEvent(c,e,b.handle);c[F.expando]=void 0}c[la.expando]&&(c[la.expando]=void 0)}}});
    d.fn.extend({detach:function(a){return ic(this,a,!0)},remove:function(a){return ic(this,a)},text:function(a){return Ga(this,function(b){return void 0===b?d.text(this):this.empty().each(function(){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||(this.textContent=b)})},null,a,arguments.length)},append:function(){return Xa(this,arguments,function(a){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||fc(this,a).appendChild(a)})},prepend:function(){return Xa(this,arguments,function(a){if(1===
    ...
    a,b=null==b?a:b,this.map(function(){return d.clone(this,a,b)})},html:function(a){return Ga(this,function(b){var c=this[0]||{},e=0,f=this.length;if(void 0===b&&1===c.nodeType)return c.innerHTML;if("string"==typeof b&&!Bd.test(b)&&!ra[(dc.exec(b)||["",""])[1].toLowerCase()]){b=d.htmlPrefilter(b);try{for(;e<f;e++)1===(c=this[e]||{}).nodeType&&(d.cleanData(ma(c,!1)),c.innerHTML=b);c=0}catch(g){}}c&&this.empty().append(b)},null,a,arguments.length)},replaceWith:function(){var a=[];return Xa(this,arguments,
    function(b){var c=this.parentNode;0>d.inArray(this,a)&&(d.cleanData(ma(this)),c&&c.replaceChild(b,this))},a)}});d.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){d.fn[a]=function(c){for(var e=[],f=d(c),g=f.length-1,h=0;h<=g;h++)c=h===g?this:this.clone(!0),d(f[h])[b](c),Pb.apply(e,c.get());return this.pushStack(e)}});var Hb=new RegExp("^("+Gc+")(?!px)[a-z%]+$","i"),tb=function(a){var b=a.ownerDocument.defaultView;return b&&
    ...
    b="1%"!==t.top;h=12===Math.round(parseFloat(t.marginLeft));n.style.right="60%";f=36===Math.round(parseFloat(t.right));c=36===Math.round(parseFloat(t.width));n.style.position="absolute";e=12===Math.round(parseFloat(n.offsetWidth/3));Pa.removeChild(m);n=null}}var b,c,e,f,g,h,m=O.createElement("div"),n=O.createElement("div");n.style&&(n.style.backgroundClip="content-box",n.cloneNode(!0).style.backgroundClip="",R.clearCloneStyle="content-box"===n.style.backgroundClip,d.extend(R,{boxSizingReliable:function(){return a(),
    c},pixelBoxStyles:function(){return a(),f},pixelPosition:function(){return a(),b},reliableMarginLeft:function(){return a(),h},scrollboxSize:function(){return a(),e},reliableTrDimensions:function(){var t,v,q,z;return null==g&&(t=O.createElement("table"),v=O.createElement("tr"),q=O.createElement("div"),t.style.cssText="position:absolute;left:-11111px;border-collapse:separate",v.style.cssText="border:1px solid",v.style.height="1px",q.style.height="9px",q.style.display="block",Pa.appendChild(t).appendChild(v).appendChild(q),
    z=H.getComputedStyle(v),g=parseInt(z.height,10)+parseInt(z.borderTopWidth,10)+parseInt(z.borderBottomWidth,10)===v.offsetHeight,Pa.removeChild(t)),g}}))}();var mc=["Webkit","Moz","ms"],lc=O.createElement("div").style,kc={},Cd=/^(none|table(?!-c[ea]).+)/,Jc=/^--/,Dd={position:"absolute",visibility:"hidden",display:"block"},Kc={letterSpacing:"0",fontWeight:"400"};d.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=fb(a,"opacity");return""===c?"1":c}}}},cssNumber:{animationIterationCount:!0,columnCount:!0,
    fillOpacity:!0,flexGrow:!0,flexShrink:!0,fontWeight:!0,gridArea:!0,gridColumn:!0,gridColumnEnd:!0,gridColumnStart:!0,gridRow:!0,gridRowEnd:!0,gridRowStart:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{},style:function(a,b,c,e){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var f,g,h,m=Aa(b),n=Jc.test(b),t=a.style;if(n||(b=Ib(m)),h=d.cssHooks[b]||d.cssHooks[m],void 0===c)return h&&"get"in h&&void 0!==(f=h.get(a,!1,e))?f:t[b];"string"===(g=typeof c)&&(f=eb.exec(c))&&
    f[1]&&(c=ac(a,b,f),g="number");null!=c&&c==c&&("number"!==g||n||(c+=f&&f[3]||(d.cssNumber[m]?"":"px")),R.clearCloneStyle||""!==c||0!==b.indexOf("background")||(t[b]="inherit"),h&&"set"in h&&void 0===(c=h.set(a,c,e))||(n?t.setProperty(b,c):t[b]=c))}},css:function(a,b,c,e){var f,g,h,m=Aa(b);return Jc.test(b)||(b=Ib(m)),(h=d.cssHooks[b]||d.cssHooks[m])&&"get"in h&&(f=h.get(a,!0,c)),void 0===f&&(f=fb(a,b,e)),"normal"===f&&b in Kc&&(f=Kc[b]),""===c||c?(g=parseFloat(f),!0===c||isFinite(g)?g||0:f):f}});
    d.each(["height","width"],function(a,b){d.cssHooks[b]={get:function(c,e,f){if(e)return!Cd.test(d.css(c,"display"))||c.getClientRects().length&&c.getBoundingClientRect().width?oc(c,b,f):Ic(c,Dd,function(){return oc(c,b,f)})},set:function(c,e,f){var g,h=tb(c),m=!R.scrollboxSize()&&"absolute"===h.position,n=(m||f)&&"border-box"===d.css(c,"boxSizing",!1,h);f=f?Jb(c,b,f,n,h):0;return n&&m&&(f-=Math.ceil(c["offset"+b[0].toUpperCase()+b.slice(1)]-parseFloat(h[b])-Jb(c,b,"border",!1,h)-.5)),f&&(g=eb.exec(e))&&
    "px"!==(g[3]||"px")&&(c.style[b]=e,e=d.css(c,b)),nc(0,e,f)}}});d.cssHooks.marginLeft=jc(R.reliableMarginLeft,function(a,b){if(b)return(parseFloat(fb(a,"marginLeft"))||a.getBoundingClientRect().left-Ic(a,{marginLeft:0},function(){return a.getBoundingClientRect().left}))+"px"});d.each({margin:"",padding:"",border:"Width"},function(a,b){d.cssHooks[a+b]={expand:function(c){var e=0,f={};for(c="string"==typeof c?c.split(" "):[c];4>e;e++)f[a+Ca[e]+b]=c[e]||c[e-2]||c[0];return f}};"margin"!==a&&(d.cssHooks[a+
    b].set=nc)});d.fn.extend({css:function(a,b){return Ga(this,function(c,e,f){var g,h={},m=0;if(Array.isArray(e)){f=tb(c);for(g=e.length;m<g;m++)h[e[m]]=d.css(c,e[m],!1,f);return h}return void 0!==f?d.style(c,e,f):d.css(c,e)},a,b,1<arguments.length)}});((d.Tween=ta).prototype={constructor:ta,init:function(a,b,c,e,f,g){this.elem=a;this.prop=c;this.easing=f||d.easing._default;this.options=b;this.start=this.now=this.cur();this.end=e;this.unit=g||(d.cssNumber[c]?"":"px")},cur:function(){var a=ta.propHooks[this.prop];
    return a&&a.get?a.get(this):ta.propHooks._default.get(this)},run:function(a){var b,c=ta.propHooks[this.prop];return this.options.duration?this.pos=b=d.easing[this.easing](a,this.options.duration*a,0,1,this.options.duration):this.pos=b=a,this.now=(this.end-this.start)*b+this.start,this.options.step&&this.options.step.call(this.elem,this.now,this),c&&c.set?c.set(this):ta.propHooks._default.set(this),this}}).init.prototype=ta.prototype;(ta.propHooks={_default:{get:function(a){var b;return 1!==a.elem.nodeType||
    null!=a.elem[a.prop]&&null==a.elem.style[a.prop]?a.elem[a.prop]:(b=d.css(a.elem,a.prop,""))&&"auto"!==b?b:0},set:function(a){d.fx.step[a.prop]?d.fx.step[a.prop](a):1!==a.elem.nodeType||!d.cssHooks[a.prop]&&null==a.elem.style[Ib(a.prop)]?a.elem[a.prop]=a.now:d.style(a.elem,a.prop,a.now+a.unit)}}}).scrollTop=ta.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&a.elem.parentNode&&(a.elem[a.prop]=a.now)}};d.easing={linear:function(a){return a},swing:function(a){return.5-Math.cos(a*Math.PI)/2},_default:"swing"};
    d.fx=ta.prototype.init;d.fx.step={};var Ya,ub,Ed=/^(?:toggle|show|hide)$/,Fd=/queueHooks$/;d.Animation=d.extend(ua,{tweeners:{"*":[function(a,b){var c=this.createTween(a,b);return ac(c.elem,a,eb.exec(b),c),c}]},tweener:function(a,b){J(a)?(b=a,a=["*"]):a=a.match(Ba);for(var c,e=0,f=a.length;e<f;e++)c=a[e],ua.tweeners[c]=ua.tweeners[c]||[],ua.tweeners[c].unshift(b)},prefilters:[function(a,b,c){var e,f,g,h,m,n,t,v="width"in b||"height"in b,q=this,z={},A=a.style,B=a.nodeType&&rb(a),K=F.get(a,"fxshow");
    for(e in c.queue||(null==(h=d._queueHooks(a,"fx")).unqueued&&(h.unqueued=0,m=h.empty.fire,h.empty.fire=function(){h.unqueued||m()}),h.unqueued++,q.always(function(){q.always(function(){h.unqueued--;d.queue(a,"fx").length||h.empty.fire()})})),b)if(f=b[e],Ed.test(f)){if(delete b[e],g=g||"toggle"===f,f===(B?"hide":"show")){if("show"!==f||!K||void 0===K[e])continue;B=!0}z[e]=K&&K[e]||d.style(a,e)}if((b=!d.isEmptyObject(b))||!d.isEmptyObject(z))for(e in v&&1===a.nodeType&&(c.overflow=[A.overflow,A.overflowX,
    A.overflowY],null==(n=K&&K.display)&&(n=F.get(a,"display")),"none"===(t=d.css(a,"display"))&&(n?t=n:(Ta([a],!0),n=a.style.display||n,t=d.css(a,"display"),Ta([a]))),("inline"===t||"inline-block"===t&&null!=n)&&"none"===d.css(a,"float")&&(b||(q.done(function(){A.display=n}),null==n&&(t=A.display,n="none"===t?"":t)),A.display="inline-block")),c.overflow&&(A.overflow="hidden",q.always(function(){A.overflow=c.overflow[0];A.overflowX=c.overflow[1];A.overflowY=c.overflow[2]})),b=!1,z)b||(K?"hidden"in K&&
    (B=K.hidden):K=F.access(a,"fxshow",{display:n}),g&&(K.hidden=!B),B&&Ta([a],!0),q.done(function(){for(e in B||Ta([a]),F.remove(a,"fxshow"),z)d.style(a,e,z[e])})),b=qc(B?K[e]:0,e,q),e in K||(K[e]=b.start,B&&(b.end=b.start,b.start=0))}],prefilter:function(a,b){b?ua.prefilters.unshift(a):ua.prefilters.push(a)}});d.speed=function(a,b,c){var e=a&&"object"==typeof a?d.extend({},a):{complete:c||!c&&b||J(a)&&a,duration:a,easing:c&&b||b&&!J(b)&&b};return d.fx.off?e.duration=0:"number"!=typeof e.duration&&(e.duration in
    d.fx.speeds?e.duration=d.fx.speeds[e.duration]:e.duration=d.fx.speeds._default),null!=e.queue&&!0!==e.queue||(e.queue="fx"),e.old=e.complete,e.complete=function(){J(e.old)&&e.old.call(this);e.queue&&d.dequeue(this,e.queue)},e};d.fn.extend({fadeTo:function(a,b,c,e){return this.filter(rb).css("opacity",0).show().end().animate({opacity:b},a,c,e)},animate:function(a,b,c,e){var f=d.isEmptyObject(a),g=d.speed(b,c,e);b=function(){var h=ua(this,d.extend({},a),g);(f||F.get(this,"finish"))&&h.stop(!0)};return b.finish=
    b,f||!1===g.queue?this.each(b):this.queue(g.queue,b)},stop:function(a,b,c){var e=function(f){var g=f.stop;delete f.stop;g(c)};return"string"!=typeof a&&(c=b,b=a,a=void 0),b&&this.queue(a||"fx",[]),this.each(function(){var f=!0,g=null!=a&&a+"queueHooks",h=d.timers,m=F.get(this);if(g)m[g]&&m[g].stop&&e(m[g]);else for(g in m)m[g]&&m[g].stop&&Fd.test(g)&&e(m[g]);for(g=h.length;g--;)h[g].elem!==this||null!=a&&h[g].queue!==a||(h[g].anim.stop(c),f=!1,h.splice(g,1));!f&&c||d.dequeue(this,a)})},finish:function(a){return!1!==
    a&&(a=a||"fx"),this.each(function(){var b=F.get(this),c=b[a+"queue"];var e=b[a+"queueHooks"];var f=d.timers,g=c?c.length:0;b.finish=!0;d.queue(this,a,[]);e&&e.stop&&e.stop.call(this,!0);for(e=f.length;e--;)f[e].elem===this&&f[e].queue===a&&(f[e].anim.stop(!0),f.splice(e,1));for(e=0;e<g;e++)c[e]&&c[e].finish&&c[e].finish.call(this);delete b.finish})}});d.each(["toggle","show","hide"],function(a,b){var c=d.fn[b];d.fn[b]=function(e,f,g){return null==e||"boolean"==typeof e?c.apply(this,arguments):this.animate(vb(b,
    !0),e,f,g)}});d.each({slideDown:vb("show"),slideUp:vb("hide"),slideToggle:vb("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(a,b){d.fn[a]=function(c,e,f){return this.animate(b,c,e,f)}});d.timers=[];d.fx.tick=function(){var a,b=0,c=d.timers;for(Ya=Date.now();b<c.length;b++)(a=c[b])()||c[b]!==a||c.splice(b--,1);c.length||d.fx.stop();Ya=void 0};d.fx.timer=function(a){d.timers.push(a);d.fx.start()};d.fx.interval=13;d.fx.start=function(){ub||(ub=!0,Kb())};
    d.fx.stop=function(){ub=null};d.fx.speeds={slow:600,fast:200,_default:400};d.fn.delay=function(a,b){return a=d.fx&&d.fx.speeds[a]||a,b=b||"fx",this.queue(b,function(c,e){var f=H.setTimeout(c,a);e.stop=function(){H.clearTimeout(f)}})};var jb=O.createElement("input");var Gd=O.createElement("select").appendChild(O.createElement("option"));jb.type="checkbox";R.checkOn=""!==jb.value;R.optSelected=Gd.selected;(jb=O.createElement("input")).value="t";jb.type="radio";R.radioValue="t"===jb.value;var kb=d.expr.attrHandle;
    ...
    function(){d.propFix[this.toLowerCase()]=this});d.fn.extend({addClass:function(a){var b,c,e,f,g,h,m,n=0;if(J(a))return this.each(function(t){d(this).addClass(a.call(this,t,Ka(this)))});if((b=Lb(a)).length)for(;c=this[n++];)if(f=Ka(c),e=1===c.nodeType&&" "+Ja(f)+" "){for(h=0;g=b[h++];)0>e.indexOf(" "+g+" ")&&(e+=g+" ");f!==(m=Ja(e))&&c.setAttribute("class",m)}return this},removeClass:function(a){var b,c,e,f,g,h,m,n=0;if(J(a))return this.each(function(t){d(this).removeClass(a.call(this,t,Ka(this)))});
    if(!arguments.length)return this.attr("class","");if((b=Lb(a)).length)for(;c=this[n++];)if(f=Ka(c),e=1===c.nodeType&&" "+Ja(f)+" "){for(h=0;g=b[h++];)for(;-1<e.indexOf(" "+g+" ");)e=e.replace(" "+g+" "," ");f!==(m=Ja(e))&&c.setAttribute("class",m)}return this},toggleClass:function(a,b){var c=typeof a,e="string"===c||Array.isArray(a);return"boolean"==typeof b&&e?b?this.addClass(a):this.removeClass(a):J(a)?this.each(function(f){d(this).toggleClass(a.call(this,f,Ka(this),b),b)}):this.each(function(){var f,
    g;if(e){var h=0;var m=d(this);for(g=Lb(a);f=g[h++];)m.hasClass(f)?m.removeClass(f):m.addClass(f)}else void 0!==a&&"boolean"!==c||((f=Ka(this))&&F.set(this,"__className__",f),this.setAttribute&&this.setAttribute("class",f||!1===a?"":F.get(this,"__className__")||""))})},hasClass:function(a){var b,c=0;for(a=" "+a+" ";b=this[c++];)if(1===b.nodeType&&-1<(" "+Ja(Ka(b))+" ").indexOf(a))return!0;return!1}});var Kd=/\r/g;d.fn.extend({val:function(a){var b,c,e,f=this[0];return arguments.length?(e=J(a),this.each(function(g){var h;
    1===this.nodeType&&(null==(h=e?a.call(this,g,d(this).val()):a)?h="":"number"==typeof h?h+="":Array.isArray(h)&&(h=d.map(h,function(m){return null==m?"":m+""})),(b=d.valHooks[this.type]||d.valHooks[this.nodeName.toLowerCase()])&&"set"in b&&void 0!==b.set(this,h,"value")||(this.value=h))})):f?(b=d.valHooks[f.type]||d.valHooks[f.nodeName.toLowerCase()])&&"get"in b&&void 0!==(c=b.get(f,"value"))?c:"string"==typeof(c=f.value)?c.replace(Kd,""):null==c?"":c:void 0}});d.extend({valHooks:{option:{get:function(a){var b=
    ...
    b,c,!0)}});R.focusin||d.each({focus:"focusin",blur:"focusout"},function(a,b){var c=function(e){d.event.simulate(b,e.target,d.event.fix(e))};d.event.special[b]={setup:function(){var e=this.ownerDocument||this.document||this,f=F.access(e,b);f||e.addEventListener(a,c,!0);F.access(e,b,(f||0)+1)},teardown:function(){var e=this.ownerDocument||this.document||this,f=F.access(e,b)-1;f?F.access(e,b,f):(e.removeEventListener(a,c,!0),F.remove(e,b))}}});var lb=H.location,Nc=Date.now(),Ub=/\?/;d.parseXML=function(a){var b;
    if(!a||"string"!=typeof a)return null;try{var c=(new H.DOMParser).parseFromString(a,"text/xml")}catch(e){}return b=c&&c.getElementsByTagName("parsererror")[0],c&&!b||d.error("Invalid XML: "+(b?d.map(b.childNodes,function(e){return e.textContent}).join("\n"):a)),c};var fd=/\[\]$/,Oc=/\r?\n/g,Ld=/^(?:submit|button|image|reset|file)$/i,Md=/^(?:input|select|textarea|keygen)/i;d.param=function(a,b){var c,e=[],f=function(g,h){var m=J(h)?h():h;e[e.length]=encodeURIComponent(g)+"="+encodeURIComponent(null==
    m?"":m)};if(null==a)return"";if(Array.isArray(a)||a.jquery&&!d.isPlainObject(a))d.each(a,function(){f(this.name,this.value)});else for(c in a)Mb(c,a[c],b,f);return e.join("&")};d.fn.extend({serialize:function(){return d.param(this.serializeArray())},serializeArray:function(){return this.map(function(){var a=d.prop(this,"elements");return a?d.makeArray(a):this}).filter(function(){var a=this.type;return this.name&&!d(this).is(":disabled")&&Md.test(this.nodeName)&&!Ld.test(a)&&(this.checked||!ib.test(a))}).map(function(a,
    b){var c=d(this).val();return null==c?null:Array.isArray(c)?d.map(c,function(e){return{name:b.name,value:e.replace(Oc,"\r\n")}}):{name:b.name,value:c.replace(Oc,"\r\n")}}).get()}});var Nd=/%20/g,Od=/#.*$/,Pd=/([?&])_=[^&]*/,Qd=/^(.*?):[ \t]*([^\r\n]*)$/gm,Rd=/^(?:GET|HEAD)$/,Sd=/^\/\//,Pc={},Nb={},Qc="*/".concat("*"),Vb=O.createElement("a");Vb.href=lb.href;d.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:lb.href,type:"GET",isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(lb.protocol),
    ...
    Ob(Ob(a,d.ajaxSettings),b):Ob(d.ajaxSettings,a)},ajaxPrefilter:rc(Pc),ajaxTransport:rc(Nb),ajax:function(a,b){function c(N,Y,Za,yb){var na,sa,xa,ka,P,X=Y;ja||(ja=!0,m&&H.clearTimeout(m),e=void 0,g=yb||"",D.readyState=0<N?4:0,na=200<=N&&300>N||304===N,Za&&(ka=function(W,S,pa){for(var ya,da,G,V,ea=W.contents,ca=W.dataTypes;"*"===ca[0];)ca.shift(),void 0===ya&&(ya=W.mimeType||S.getResponseHeader("Content-Type"));if(ya)for(da in ea)if(ea[da]&&ea[da].test(ya)){ca.unshift(da);break}if(ca[0]in pa)G=ca[0];
    else{for(da in pa){if(!ca[0]||W.converters[da+" "+ca[0]]){G=da;break}V||(V=da)}G=G||V}if(G)return G!==ca[0]&&ca.unshift(G),pa[G]}(q,D,Za)),!na&&-1<d.inArray("script",q.dataTypes)&&0>d.inArray("json",q.dataTypes)&&(q.converters["text script"]=function(){}),ka=function(W,S,pa,ya){var da,G,V,ea,ca,za={},Ma=W.dataTypes.slice();if(Ma[1])for(V in W.converters)za[V.toLowerCase()]=W.converters[V];for(G=Ma.shift();G;)if(W.responseFields[G]&&(pa[W.responseFields[G]]=S),!ca&&ya&&W.dataFilter&&(S=W.dataFilter(S,
    W.dataType)),ca=G,G=Ma.shift())if("*"===G)G=ca;else if("*"!==ca&&ca!==G){if(!(V=za[ca+" "+G]||za["* "+G]))for(da in za)if((ea=da.split(" "))[1]===G&&(V=za[ca+" "+ea[0]]||za["* "+ea[0]])){!0===V?V=za[da]:!0!==za[da]&&(G=ea[0],Ma.unshift(ea[1]));break}if(!0!==V)if(V&&W["throws"])S=V(S);else try{S=V(S)}catch(Ab){return{state:"parsererror",error:V?Ab:"No conversion from "+ca+" to "+G}}}return{state:"success",data:S}}(q,ka,D,na),na?(q.ifModified&&((P=D.getResponseHeader("Last-Modified"))&&(d.lastModified[f]=
    P),(P=D.getResponseHeader("etag"))&&(d.etag[f]=P)),204===N||"HEAD"===q.type?X="nocontent":304===N?X="notmodified":(X=ka.state,sa=ka.data,na=!(xa=ka.error))):(xa=X,!N&&X||(X="error",0>N&&(N=0))),D.status=N,D.statusText=(Y||X)+"",na?B.resolveWith(z,[sa,X,D]):B.rejectWith(z,[D,X,xa]),D.statusCode(U),U=void 0,n&&A.trigger(na?"ajaxSuccess":"ajaxError",[D,q,na?sa:xa]),K.fireWith(z,[D,X]),n&&(A.trigger("ajaxComplete",[D,q]),--d.active||d.event.trigger("ajaxStop")))}"object"==typeof a&&(b=a,a=void 0);b=b||
    {};var e,f,g,h,m,n,t,v,q=d.ajaxSetup({},b),z=q.context||q,A=q.context&&(z.nodeType||z.jquery)?d(z):d.event,B=d.Deferred(),K=d.Callbacks("once memory"),U=q.statusCode||{},va={},ha={},oa="canceled",D={readyState:0,getResponseHeader:function(N){var Y;if(ja){if(!h)for(h={};Y=Qd.exec(g);)h[Y[1].toLowerCase()+" "]=(h[Y[1].toLowerCase()+" "]||[]).concat(Y[2]);Y=h[N.toLowerCase()+" "]}return null==Y?null:Y.join(", ")},getAllResponseHeaders:function(){return ja?g:null},setRequestHeader:function(N,Y){return null==
    ja&&(N=ha[N.toLowerCase()]=ha[N.toLowerCase()]||N,va[N]=Y),this},overrideMimeType:function(N){return null==ja&&(q.mimeType=N),this},statusCode:function(N){var Y;if(N)if(ja)D.always(N[D.status]);else for(Y in N)U[Y]=[U[Y],N[Y]];return this},abort:function(N){N=N||oa;return e&&e.abort(N),c(0,N),this}};if(B.promise(D),q.url=((a||q.url||lb.href)+"").replace(Sd,lb.protocol+"//"),q.type=b.method||b.type||q.method||q.type,q.dataTypes=(q.dataType||"*").toLowerCase().match(Ba)||[""],null==q.crossDomain){var M=
    O.createElement("a");try{M.href=q.url,M.href=M.href,q.crossDomain=Vb.protocol+"//"+Vb.host!=M.protocol+"//"+M.host}catch(N){q.crossDomain=!0}}if(q.data&&q.processData&&"string"!=typeof q.data&&(q.data=d.param(q.data,q.traditional)),sc(Pc,q,b,D),ja)return D;for(t in(n=d.event&&q.global)&&0==d.active++&&d.event.trigger("ajaxStart"),q.type=q.type.toUpperCase(),q.hasContent=!Rd.test(q.type),f=q.url.replace(Od,""),q.hasContent?q.data&&q.processData&&0===(q.contentType||"").indexOf("application/x-www-form-urlencoded")&&
    (q.data=q.data.replace(Nd,"+")):(v=q.url.slice(f.length),q.data&&(q.processData||"string"==typeof q.data)&&(f+=(Ub.test(f)?"&":"?")+q.data,delete q.data),!1===q.cache&&(f=f.replace(Pd,"$1"),v=(Ub.test(f)?"&":"?")+"_="+Nc++ +v),q.url=f+v),q.ifModified&&(d.lastModified[f]&&D.setRequestHeader("If-Modified-Since",d.lastModified[f]),d.etag[f]&&D.setRequestHeader("If-None-Match",d.etag[f])),(q.data&&q.hasContent&&!1!==q.contentType||b.contentType)&&D.setRequestHeader("Content-Type",q.contentType),D.setRequestHeader("Accept",
    q.dataTypes[0]&&q.accepts[q.dataTypes[0]]?q.accepts[q.dataTypes[0]]+("*"!==q.dataTypes[0]?", "+Qc+"; q=0.01":""):q.accepts["*"]),q.headers)D.setRequestHeader(t,q.headers[t]);if(q.beforeSend&&(!1===q.beforeSend.call(z,D,q)||ja))return D.abort();if(oa="abort",K.add(q.complete),D.done(q.success),D.fail(q.error),e=sc(Nb,q,b,D)){if(D.readyState=1,n&&A.trigger("ajaxSend",[D,q]),ja)return D;q.async&&0<q.timeout&&(m=H.setTimeout(function(){D.abort("timeout")},q.timeout));try{var ja=!1;e.send(va,c)}catch(N){if(ja)throw N;
    ...
    a.guid=a.guid||d.guid++,f};d.holdReady=function(a){a?d.readyWait++:d.ready(!0)};d.isArray=Array.isArray;d.parseJSON=JSON.parse;d.nodeName=qa;d.isFunction=J;d.isWindow=Ra;d.camelCase=Aa;d.type=Qa;d.now=Date.now;d.isNumeric=function(a){var b=d.type(a);return("number"===b||"string"===b)&&!isNaN(a-parseFloat(a))};d.trim=function(a){return null==a?"":(a+"").replace(Ud,"")};"function"==typeof define&&define.amd&&define("jquery",[],function(){return d});var Vd=H.jQuery,Wd=H.$;return d.noConflict=function(a){return H.$===
    d&&(H.$=Wd),a&&H.jQuery===d&&(H.jQuery=Vd),d},"undefined"==typeof bb&&(H.jQuery=H.$=d),d});